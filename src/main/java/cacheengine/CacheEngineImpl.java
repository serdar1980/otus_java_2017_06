...
public class CacheEngineImpl<K, V> implements CacheEngine<K, V> {
    ...
    private void addCacheEnigeToNotificationListener() {
        if (!objectWasAdd) {
    ...
    public void put(K key, V elemet) {
        addCacheEnigeToNotificationListener();
    ...
    public void clearCache() {
        System.out.println("GC Event called method");
